...
function scrollDetect(){
    ...
    projectSection.onscroll = function() {
        ...
        if (currentScroll > 0 && lastScroll <= currentScroll){
          ...
          if(projectSection.scrollHeight - projectSection.clientHeight - projectSection.scrollTop < 100){
            if(b<=90){
                b=b+20
            }
...
function isScrollable(){
    if(projectSection.scrollHeight - projectSection.scrollTop === projectSection.clientHeight){
